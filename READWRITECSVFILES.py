...
def write_csv_file(csv_table, file_name):
    ...
    file_delimiter=","
    quoting_value=csv.QUOTE_MINIMAL
...
##    test_case_copy = read_csv_file("test_case_copy.csv")
    print()
    ...
    # Test whether two tables are the same This code was not written by me, I used the solution from the provider as I didn't udnerstand the algorithm
